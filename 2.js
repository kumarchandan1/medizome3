$(document).ready(function(){
	...
	var ProcessContainer = {
			...
			setTimeout(function () {
				$('.class123').hide();
				BotMessageContainer.BotMessage('Hii this is Video streaming');
				BotMessageContainer.BotMessage('Here is some movies list Do you want to watch');
  ...
  $("#closebutton").click(function(e){
    ...
    $(".StartChat").click(function(){
      ...
      $('#closebutton').fadeOut({ queue: false, duration: 200 });
		...
		BotMessageContainer.BotMessage('This is video streaming chatbot.');
     BotMessageContainer.BotMessage('if you can asked i can replay something');
